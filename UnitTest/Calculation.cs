...
namespace UnitTest
{
    ...
    public class Calculation
    {
        ...
        public void Add() 
        {
            ...
            // inside a test menue for Enterprise Edition(only for Enterprise Edition) there is a option 'Analyze Code Coverage for all' unit test case , Currently i,am using Community Edition.
        }
